	...
	public static void main(String[] args) {
		...
		for (int i = 1; i<7; i++) {
			...
			if (userGuess.length() != 5) {
				System.out
						.println("Please ensure you enter a 5 letter word.");
				i--;
			}
			...
			//ensures all inputted values are letters
				...
				System.out
						.println("Please only enter letters.");
				i--;
			}
			...
			// if word is correct, print success output
				...
				System.out
						.println(Utils.returnSuccessToUser(randomWord, germanWord, i));
				break;
			}
			...
			// if 6th guess, print failure output
				...
				System.out
						.println(Utils.returnFailureToUser(randomWord, germanWord));
			}
